...
// This variable serves as a instance of subscription (or websocket)
// you'll use this variable to unsubscribe from the associated subscription.
var subsHub;    
...
function subsToHub() {
  subsHub = API.graphql(
    ...
    next: _subsToHub,   // function name (run everytime we get a response)
...
function DashBoard() {
    ...
    const fetchValues = (res) => {
        ...
        if(singleHub && singleHub.length > 0) {
            ...
            avgTemp = Math.round(avgTemp/length , 2);
            avgMoist = Math.round(avgMoist/length , 2);
